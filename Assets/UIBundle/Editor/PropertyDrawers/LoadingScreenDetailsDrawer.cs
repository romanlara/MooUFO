...
namespace UIBundle
{
	[CustomPropertyDrawer(typeof(LoadingScreen.LoadingScreenDetails))]
	public class LoadingScreenDetailsDrawer : PropertyDrawer 
	{
		public class Styles
		{
		...
		public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
		{
			...
			label = EditorGUI.BeginProperty(position, label, property);
			{
				...
				contentPosition.y += 3;
				EditorGUI.PropertyField(contentPosition, property.FindPropertyRelative("m_SceneName"), new GUIContent("Scene Name"));
